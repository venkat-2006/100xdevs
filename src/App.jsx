...
function App() {
  ...
  return (
    <>
      ...
      <main>
        <div className="bg-black text-white dark:bg-white dark:text-black h-screen flex flex-col items-center justify-center text-3xl transition-all duration-500">
          ...
          <div className="relative w-full py-6 bg-black dark:bg-white">
            ...
            <div className="flex-[2]">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col leading-tight">
                  ...
                  <p className="text-gray-300 dark:text-gray-600 mt-1 text-lg">because 10x ain't enough.</p>
                </div>
              </div>
              
              <div className="pt-10 text-lg">Follow us</div>
              <div className="flex gap-3 mt-3">
                ...
                <a
                  ...
                  className="rounded-lg bg-gray-800/10 p-2 text-gray-200 dark:text-gray-800 transition-all duration-300 hover:text-blue-900"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
