        ...
        <style>{`
          * {
          ...
          @keyframes scroll {
            ...
            100% {
              transform: translateX(calc(-420px * 5 - 24px * 5));
            }
          }
          ...
          .light-mode-bg {
            background: linear-gradient(to bottom, #ffffff 0%, #f3f4f6 30%, #e5e7eb 70%, #f9fafb 100%);
          }
        `}</style>
          ...
          <div className="text-white dark:text-black h-screen flex flex-col items-center justify-center text-3xl transition-all duration-500">
            <div className="flex flex-col text-7xl font-black tracking-tighter mt-32">
              <div className="flex flex-wrap items-baseline">
                ...
                <span className="text-white dark:text-black">&nbsp;because</span>
              </div>
              <div className="text-white dark:text-black pl-8">10x ain't enough!</div>
            </div>
            <div className="p-4 text-lg text-gray-300 dark:text-gray-700">
                  ...
                  <div className="flex gap-6 shrink-0">
                    {[
                      ...
                      <img
                        ...
                        src={src}
                        alt={`Course ${i + 1}`}
                        className="w-[420px] h-[220px] object-cover rounded-xl shadow-lg shadow-white/10 transition-all duration-500 hover:-translate-y-3 hover:shadow-blue-500/30 cursor-pointer"
                      />
                    ))}
                  </div>
                  <div className="flex gap-6 shrink-0">
          ...
          <div className="min-h-[380px] flex items-center justify-center border-b border-white/10 dark:border-gray-300 py-6">
            <div className="relative text-white w-full max-w-[1300px] mx-4 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-800 rounded-2xl p-8 min-h-[330px] shadow-2xl shadow-blue-500/20 flex items-center justify-between overflow-hidden">
              ...
              <div className="z-10 max-w-[800px]">
                ...
                <div className="text-xl pt-4 opacity-90">
              ...
              <div className="absolute right-6 bottom-0 top-10 group hidden lg:block">
                <img
                  ...
                  alt="Mockup"
                  className="w-[350px] rotate-3 transition-all duration-300 group-hover:-translate-y-4 group-hover:rotate-6 cursor-pointer animate-tilt"
                />
              </div>
            </div>
          </div>

          <footer className="bg-black/40 backdrop-blur-sm text-white dark:bg-white/40 dark:text-black border-t border-white/10 dark:border-gray-300 transition-all duration-500 py-12 px-12">
            <div className="flex gap-12 flex-wrap">
              <div className="flex-[2] min-w-[300px]">
                ...
                <div className="flex gap-3 mt-3">
                  <a
                    ...
                    className="rounded-lg bg-blue-500/20 p-2 text-blue-400 transition-all duration-300 hover:bg-blue-500/30 hover:text-blue-300"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="rounded-lg bg-pink-500/20 p-2 text-pink-400 transition-all duration-300 hover:bg-pink-500/30 hover:text-pink-300"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="rounded-lg bg-red-500/20 p-2 text-red-400 transition-all duration-300 hover:bg-red-500/30 hover:text-red-300"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="rounded-lg bg-gray-700/20 p-2 text-gray-400 dark:text-gray-700 transition-all duration-300 hover:bg-gray-700/30 hover:text-gray-300"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <div className="flex-1 min-w-[150px]">
                ...
                <div className="pt-2 text-gray-400 dark:text-gray-600 hover:text-blue-400 dark:hover:text-blue-500 duration-300 cursor-pointer">
                  Projects
                </div>
                <div className="pt-2 text-gray-400 dark:text-gray-600 hover:text-blue-400 dark:hover:text-blue-500 duration-300 cursor-pointer">
                  Report
