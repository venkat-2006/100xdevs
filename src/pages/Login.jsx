...
export default function Login({ lightMode, setLightMode }) {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen flex items-center justify-center px-4 transition-colors duration-300 ${lightMode
          ? 'bg-gradient-to-b from-white to-gray-100'
          : 'bg-[linear-gradient(to_bottom,#000000_0%,#1a1a1a_30%,#0a0a0a_70%,#000000_100%)]'
        }`}>
        <div className="w-[420px] h-[420px]  bg-white/6 dark:bg-white/95 rounded-xl shadow-xl backdrop-blur-md border border-white/10 dark:border-gray-200/20 p-8 flex flex-col justify-between">
          <div className="text-center">
            <h1 className="text-[2.1rem] font-extrabold text-white dark:text-black">
              Welcome to <span className="bg-gradient-to-b from-blue-400 to-blue-700 bg-clip-text text-transparent">100xDevs</span>
            </h1>
            <p className="mt-0 text-xl text-gray-300 dark:text-gray-700">
          ...
          <form className="mt-6 flex-1 flex flex-col justify-center" onSubmit={handleSubmit}>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 rounded-md bg-white/5 border border-white/10 dark:bg-white dark:border-gray-200 text-white dark:text-black placeholder:text-gray-400 dark:placeholder:text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 transition mb-4"
            />
